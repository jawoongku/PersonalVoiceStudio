...
- [x] Fixed app pipeline parquet subprocess to use the active conda interpreter (`sys.executable`); host `pipeline_test2` completed successfully after the logged pandas failure.
